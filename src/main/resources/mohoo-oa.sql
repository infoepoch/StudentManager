/*
 ...
 Source Database       : mohoo-oa

 Target Server Type    : MySQL
 Target Server Version : 50712
 File Encoding         : utf-8

 Date: 05/03/2017 17:32:34 PM
*/
...
CREATE TABLE `student` (
  ...
  `stu_no` varchar(32) DEFAULT NULL,
  `age` int(11) DEFAULT NULL,
  `birthday` varchar(20) DEFAULT '2017-05-03',
  PRIMARY KEY (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `student` VALUES ('1', 'cnn', '007', '30', '2017-05-03'), ('2', 'dyj', '001', '0', '2017-05-03'), ('3', 'dyj', '001', '0', '2017-05-03'), ('5', 'dd', 'e33', '0', '2017-05-03'), ('6', '水电费', '222', '0', '2017-05-03'), ('7', '23', '33', '0', '2017-05-03'), ('8', '33', '33', '0', '2017-05-03');
COMMIT;
